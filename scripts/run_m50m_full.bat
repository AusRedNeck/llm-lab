...
python -u scripts\tokenize_stream.py data/openwebtext_combined.txt data/bpe_owt4k.json data/openwebtext_combined_bpe_owt4k.pt >> overnight_m50m_full.log 2>&1
