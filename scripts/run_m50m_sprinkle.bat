...
python -u scripts\sprinkle_tokenize.py data/openwebtext_combined.txt data/bpe_owt4k.json data/openwebtext_combined_bpe_owt4k.pt --workers 8 >> overnight_m50m_full.log 2>&1
