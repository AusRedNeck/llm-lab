...
python -u scripts\tokenize_owt_16k.py --smoke >> logs\16k_smoke.log 2>&1
if errorlevel 1 goto :fail

python -u scripts\verify_tokens.py --bin data/tok16k_smoke.bin --vocab data/bpe_owt16k.json --src data/openwebtext/shards/train-00000-of-00080.txt --manifest >> logs\16k_smoke.log 2>&1
if errorlevel 1 goto :fail
